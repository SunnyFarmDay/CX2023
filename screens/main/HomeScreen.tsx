        ...
        <View style={{backgroundColor: 'ghostwhite', height: '100%'}}>
          <ScrollView
            ...
            showsVerticalScrollIndicator={false}>
              <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 0, position: 'relative'}}>
                <Image source={require('../../assets/HomeScreen/HomeScreen_background_1.jpg')} style={{width: '100%', aspectRatio: 9 / 20}} 
          resizeMode="cover"/>
                <TouchableOpacity style={{position: 'absolute', top: 10, right: 10, width: 50, height: 50, borderRadius: 25, backgroundColor: 'white'}} onPress={() => setOpenSideBar(true) } />
                ...
                <Text style={{fontSize: 15, fontWeight: 'semibold', color: Colors.black, position: 'absolute', top: 60, left: 20}}>You have earned 3 badges</Text>
                <Text style={{fontSize: 20, fontWeight: 'semibold', color: Colors.black, position: 'absolute', top: 105, left: 20}}>Let's get moving to get more badges!</Text>
